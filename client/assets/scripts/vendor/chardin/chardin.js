        ...
        chardinJs = (function() {
            ...
            chardinJs.prototype._add_overlay_layer = function() {
                ...
                if (this.$el.prop('tagName') === "BODY") {
                    ...
                    if (element_position) {
                        styleText += "width: " + element_position.width + "px; height:" + element_position.height + "px; top:" + element_position.top + "px;left: " + element_position.left + "px; z-index: -1";
                        overlay_layer.setAttribute("style", styleText);
                    }
                }
                ...
                return setTimeout(function() {
                    styleText += "opacity: .8;opacity: .8;-ms-filter: 'progid:DXImageTransform.Microsoft.Alpha(Opacity=80)';filter: alpha(opacity=80); z-index:-1";
